...
import 'package:youdeyiwu_app/postid/widget/post_child_reply_view.dart';
...
Widget buildItem({
  required BuildContext context,
  required bool right,
  required PostCommentParentReplyVo element,
  required int commentId,
  required int replyId,
}) {
  return Column(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (element != null && element.content.isNotEmpty)
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => PostChildReplyView(
                            element: element,
                            commentId: commentId,
                            replyId: replyId,
                          )),

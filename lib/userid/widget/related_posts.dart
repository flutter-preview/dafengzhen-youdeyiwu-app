...
class _RelatedPostsState extends State<RelatedPosts> {
  ...
  void initState() {
    ...
    _userIdController = UserIdController(context: context);
    _userIdController.init(id: widget.id);
  }
  ...
  void _scrollListener() {
    if (_scrollController.position.pixels ==
      ...
      _userIdController.LoadMoreData();
    }
  }
            ...
            InkWell(
              onTap: () {
                if (currentSection != null && currentSection.id == element.id) {
                  ...
                  _userIdController.loadPostData(id: id);
                } else {
                  context.read<UserBloc>().add(UpdateCurrentSectionUserEvent(
                        currentSection: element,
                      ));
                  _userIdController.loadPostData(id: id, sectionVo: element);
                }

                if (isClickContent == true) {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => RelatedPosts(
                            id: id,
                            isClickContent: true,
                            isClickPost: true,
                          )));
            ...
            InkWell(
              onTap: () {
                if (currentTag != null && currentTag.id == element.id) {
                  ...
                  _userIdController.loadPostData(
                    id: id,
                  );
                } else {
                  ...
                  _userIdController.loadPostData(id: id, tagVo: element);
                }
